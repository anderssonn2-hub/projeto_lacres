...
<head>
    <meta charset="UTF-8">
    <title>Conferência de Pacotes v9.4</title>
    <style>
...
<body>
    <div class="container">
        <h1>📋 Conferência de Pacotes v9.4</h1>
...
if (!empty($pt_todos)) {
    ...
    echo '<table><thead><tr><th>Regional</th><th>Lote</th><th>Posto</th><th>Data</th><th>Qtd</th><th>Código</th><th>Lido em</th></tr></thead><tbody>';
    foreach ($pt_todos as $p) {
        $cls = $p['conf'] ? 'confirmado' : '';
        $lido_display = $p['lido_em'] ? "<span class='lido-em'>{$p['lido_em']}</span>" : "<span class='nao-lido'>Não conferido</span>";

        ...
        <div class="actions">
          ...
          <div class="card-toggle-wrap">
            <button type="button" class="card-toggle-btn" id="btn-dinamicos" onclick="toggleCards('dinamicos')">
              <span class="card-toggle-arrow">&#9658;</span> Ofícios Dinâmicos PT
            </button>
            <div class="card-toggle-content" id="card-dinamicos">
              <a class="btn btn-oficio" href="gera_oficio_poupa_tempo_dinamico.php">
                Gerar Ofício Poupa Tempo Dinâmico (Para os postos da capital de 05 a 80)
              ...
              <a class="btn btn-oficio" href="gera_oficio_poupa_tempo_dinamico.php?modo_correios=1">
                Gerar Ofício Dinâmico Poupa Tempo (Com Displays Correios - Todos os postos)
                <span>Com folha inicial de Lacre PT e Etiqueta Correios – todos os postos</span>
              </a>
            </div>
          </div>
        </div>

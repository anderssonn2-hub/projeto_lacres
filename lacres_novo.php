    ...
    <table id="tabela-<?php echo strtolower(str_replace(' ', '-', $grupo)) ?>" data-grupo="<?php echo htmlspecialchars($grupo, ENT_QUOTES, 'UTF-8') ?>">
        ...
        <tbody>
            ...
            <tr data-posto-codigo="<?php echo $dado['posto_codigo'] ?>" data-grupo="<?php echo $grupo ?>" data-regional="<?php echo isset($dado['regional']) ? htmlspecialchars($dado['regional'], ENT_QUOTES, 'UTF-8') : '0' ?>" data-regional-codigo="<?php echo isset($dado['regional']) ? htmlspecialchars($dado['regional'], ENT_QUOTES, 'UTF-8') : '0' ?>" data-linha-inserida="<?php echo !empty($dado['manual_inserido']) ? '1' : '0' ?>" <?php if ($grupo === 'CENTRAL IIPR'): ?>class="linha-central" data-central-index="<?php echo $key ?>"<?php endif; ?>>
                ...
                <td><?php if ($grupo === 'POUPA TEMPO'): ?>—<?php else: ?><div class="lacre-wrapper"><input class="lacre" type="text" name="lacre_iipr[<?php echo htmlspecialchars($dado['posto_codigo'], ENT_QUOTES, 'UTF-8') ?>]" value="<?php echo htmlspecialchars(isset($dado['lacre_iipr']) ? $dado['lacre_iipr'] : '', ENT_QUOTES, 'UTF-8') ?>" data-indice="<?php echo $dado['posto_codigo'] ?>" data-tipo="iipr" inputmode="numeric" placeholder="14266 ou 14266-14267"><button type="button" class="btn-lacre-avulso no-print" data-tipo-avulso="iipr" title="Ativar lacre avulso">Av</button></div><?php endif; ?></td>
                <td><?php if ($grupo === 'POUPA TEMPO'): ?>—<?php else: ?><div class="lacre-wrapper"><input class="lacre <?php if ($grupo === 'CENTRAL IIPR'): ?>central-correios<?php endif; ?>" type="text" name="lacre_correios[<?php echo htmlspecialchars($dado['posto_codigo'], ENT_QUOTES, 'UTF-8') ?>]" value="<?php echo htmlspecialchars(isset($dado['lacre_correios']) ? $dado['lacre_correios'] : '', ENT_QUOTES, 'UTF-8') ?>" data-indice="<?php echo $dado['posto_codigo'] ?>" data-tipo="correios" inputmode="numeric" placeholder="14268"><button type="button" class="btn-lacre-avulso no-print" data-tipo-avulso="correios" title="Ativar lacre avulso">Av</button></div><?php endif; ?></td>
                <td class="acoes-cell">
    <?php if ($grupo === 'POUPA TEMPO'): ?>—

...
if (isset($id_despacho_post) && $id_despacho_post > 0) {
    ...
    $titulo_pdf = $id_despacho_post . ($modo_visual_correios ? '_poupa_tempo_interior_' : '_poupa_tempo_capital_e_metropolitano_') . $data_titulo;
}
?>
...
document.addEventListener('DOMContentLoaded', function() {
    mostrarModalResultadoSalvamento(<?php echo json_encode_legado_seguro($mensagem_status, JSON_UNESCAPED_UNICODE); ?>, function() {
        ...
        // v1.2.3: pequeno delay para garantir que o modal foi removido antes de abrir impressão
        setTimeout(function() {
            if (typeof imprimirSelecionados === 'function') {
